...
class PhysPlot:
    ...
    def workflow_script(self) -> str:
        ...
        return (
            ...
            "Edit WORKFLOW_STEPS directly, import build_workflow() in Python, or\n"
            "call run() from a notebook/script. For terminal batches, use:\n"
            ...
            "    if input_path:\n"
            "        steps = load_input(pp, input_path, steps, loader=loader)\n"
