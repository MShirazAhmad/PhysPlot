...
[UI Reference](UI-Reference) › Simple Mode › 2. Mathematical Transformation
...
![Mathematical Transformation panel](images/ui/ui_transformation.png)
...
- **A plugin error** opens a *Transformation failed* dialog that names the plugin file.
  Nothing is recorded.
- **Undo** a transformation by deleting its row in [Build Protocol](UI-Build-Protocol).
