...
![Imported XRD scan](images/sequence/seq_01_import.png)
...
![Baseline removal configured](images/sequence/seq_02_baseline.png)
...
![New columns with Y moved](images/sequence/seq_03_new_columns.png)
...
![Plot window](images/sequence/seq_04_plot_window.png)
...
![Recorded protocol](images/sequence/seq_05_protocol.png)
...
[Build Protocol](UI-Build-Protocol) for every control on this tab.
...
![Sequence saved](images/sequence/seq_06_saved.png)
...
![Sequence imported](images/sequence/seq_07_imported.png)
...
![Sequence applied](images/sequence/seq_08_applied.png)
...
![Editing the sequence code](images/sequence/seq_09_code_edit.png)
...
![Bulk run complete](images/sequence/seq_10_bulk_run.png)
...
[Run Sequence](UI-Run-Sequence#which-files-are-processed) for the full rules.
...
![Bulk output plot for the 800 °C scan](images/sequence/seq_12_output_plot.png)
...
![Bulk run failed](images/sequence/seq_11_bulk_failed.png)
...
See [Bulk Runs and Headless Use](Bulk-Runs-and-Headless) for all options.
