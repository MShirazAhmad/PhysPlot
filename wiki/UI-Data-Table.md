...
[UI Reference](UI-Reference) › Data Table
...
(see [Build Protocol](UI-Build-Protocol)).

![Data table with numbered parts](images/ui/ui_table.png)
...
![Column header menu](images/ui/ui_table_column_menu.png)
...
![Row menu](images/ui/ui_table_row_menu.png)
...
![Cell menu](images/ui/ui_table_cell_menu.png)
...
![Rename Column dialog](images/ui/ui_rename_dialog.png)
