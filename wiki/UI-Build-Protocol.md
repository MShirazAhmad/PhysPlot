...
[UI Reference](UI-Reference) › Advanced Mode › Build Protocol
...
![Build Protocol tab](images/ui/ui_build_protocol.png)

1. **Mode tabs.** **Build Protocol** (this tab) and [Run Sequence](UI-Run-Sequence).
...
![A failed row with later rows skipped](images/troubleshooting/trouble_02_failed_row.png)
...
![Row context menu](images/ui/ui_protocol_row_menu.png)
...
![Code view](images/ui/ui_code_view.png)
...
![Syntax error dialog](images/troubleshooting/trouble_03_code_syntax_error.png)
