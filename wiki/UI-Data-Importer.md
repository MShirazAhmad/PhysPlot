...
[UI Reference](UI-Reference) › Simple Mode › 1. Data Importer

The first Simple Mode panel brings data into the table and saves it out again.

![Data Importer panel](images/ui/ui_data_importer.png)
...
Plotter Module menu while its data is loaded. See [Extending PhysPlot](Extending-PhysPlot). Worked examples, from the raw
...
| File | Contents |
| --- | --- |
| `data.csv` | The current table (the filled block, see [Data Table](UI-Data-Table#what-counts-as-the-data)). |
