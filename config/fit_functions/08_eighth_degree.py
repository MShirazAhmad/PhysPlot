"""Eighth-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 8``. The application computes
...
DISPLAY_NAME = "8th degree"
DEFAULT_LABEL = "8th degree"
KIND = "poly"
DEGREE = 8
