"""Sixth-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 6``. The application computes
...
DISPLAY_NAME = "6th degree"
DEFAULT_LABEL = "6th degree"
KIND = "poly"
DEGREE = 6
