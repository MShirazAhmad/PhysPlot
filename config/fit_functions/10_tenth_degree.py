"""Tenth-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 10``. The application computes
...
DISPLAY_NAME = "10th degree"
DEFAULT_LABEL = "10th degree"
KIND = "poly"
DEGREE = 10
