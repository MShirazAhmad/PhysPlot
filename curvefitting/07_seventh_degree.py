"""Seventh-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 7``. The application computes
...
DISPLAY_NAME = "7th degree"
DEFAULT_LABEL = "7th degree"
KIND = "poly"
DEGREE = 7
