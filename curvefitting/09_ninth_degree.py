"""Ninth-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 9``. The application computes
...
DISPLAY_NAME = "9th degree"
DEFAULT_LABEL = "9th degree"
KIND = "poly"
DEGREE = 9
