"""Fifth-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 5``. The application computes
...
DISPLAY_NAME = "5th degree"
DEFAULT_LABEL = "5th degree"
KIND = "poly"
DEGREE = 5
