"""Fourth-degree polynomial curve fit plugin for PhysPlot.

Definition structure:
    Polynomial fit with ``DEGREE = 4``. The application computes
...
DISPLAY_NAME = "4th degree"
DEFAULT_LABEL = "4th degree"
KIND = "poly"
DEGREE = 4
