...
- ``config/transformations/`` for table-column transformations.
- ``config/fit_functions/`` for plot curve-fit models.
- ``config/data_importers/`` for importing new data formats.
- ``config/templates/`` for reusable Figure Editor templates.
