<!-- Generated from wiki/UI-Plotter-Module.md by scripts/sync_wiki_to_docs.py. Edit the wiki page. -->

# Plotter Module

[UI Reference](index.md) › Simple Mode › 3. Plotter Module
...
![Plotter Module panel](../../wiki/images/ui/ui_plotter_module.png)
...
3. **Template.** A saved figure style (fonts, sizes, colours, grid) applied after the
   ...
   `config/templates/`; make your own in the [Figure Editor](figure_editor.md#save-as-template).
...
file, choose **File → Reload Config Modules**. See [Extending PhysPlot](../extensions/index.rst).
